...
export const BlogLatestPost = () => {
  return (
    <Fragment>
      <div className="container bs-lp-header">
        <h2 className="secondary-title">Latest Post</h2>
        <button className="sign-in-btn">Browse All Post</button>
      </div>
      <section className="container blogsingle-latestposts flex-column">
